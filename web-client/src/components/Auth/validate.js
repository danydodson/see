...
const validate = withFormik({
  validationSchema: Yup.object().shape({
    firstname: Yup.string()
      ...
      .max(30, 'First name must contain fewer then 30 characters.')
      .required('First name is required.'),

    lastname: Yup.string()
      .min(2, "C'mon, your lastname is longer than that.")
      .max(30, 'Last name must contain fewer then 30 characters.')
